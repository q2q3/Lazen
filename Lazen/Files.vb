        ...
        If FormatConverters.removeSpacesAtBeginningAndEnd(realinput).ToLower.StartsWith("file") Then
            ...
            If realinput.Substring(4).StartsWith(".") Then
                If realinput.Substring(5).ToLower.StartsWith("info") Then
                    Dim prepareFileToAnalyze = FormatConverters.ConvertToAbleToRead(realinput.Substring(9))
                    If prepareFileToAnalyze.Contains("::") Then
                        Dim fileToAnalyze = FormatConverters.getExpression(FormatConverters.ConvertToAbleToRead(FormatConverters.removeSpacesAtBeginningAndEnd(prepareFileToAnalyze.Substring(0, prepareFileToAnalyze.LastIndexOf("::")))))
                        Dim getInformationToGet = FormatConverters.getExpression(FormatConverters.removeSpacesAtBeginningAndEnd(FormatConverters.ConvertToAbleToRead(prepareFileToAnalyze.Substring(prepareFileToAnalyze.LastIndexOf("::") + 2))))
            ...
            Else
                If realinput.Substring(5).ToLower.StartsWith("getattributes") Then
                    ...
                    Dim checkPointRealInput = realinput.Substring(5)
                    If checkPointRealInput.Substring(13).StartsWith(".") Then

                        Dim saveAtPoint = checkPointRealInput.Substring(14)

                        If saveAtPoint.ToLower.StartsWith("archivestate") Then

                            Dim getCurrentExpression = FormatConverters.ConvertToAbleToRead(FormatConverters.removeSpacesAtBeginningAndEnd(saveAtPoint.Substring(12)))
                        ...
                        ElseIf saveAtPoint.ToLower.StartsWith("compressedstate") Then
                            ...
                            Dim getCurrentExpression = FormatConverters.ConvertToAbleToRead(FormatConverters.removeSpacesAtBeginningAndEnd(saveAtPoint.Substring(15)))
                            If File.Exists(FormatConverters.getExpression(getCurrentExpression)) Then
                                Dim FilePath = FormatConverters.getExpression(getCurrentExpression)
                                Dim attributes As FileAttributes = File.GetAttributes(FilePath)
                        ...
                        ElseIf saveAtPoint.ToLower.StartsWith("hiddenstate") Then
                            ...
                            Dim getCurrentExpression = FormatConverters.ConvertToAbleToRead(FormatConverters.removeSpacesAtBeginningAndEnd(saveAtPoint.Substring(11)))
                            If File.Exists(FormatConverters.getExpression(getCurrentExpression)) Then
                                Dim FilePath = FormatConverters.getExpression(getCurrentExpression)
                                Dim attributes As FileAttributes = File.GetAttributes(FilePath)
                        ...
                        ElseIf saveAtPoint.ToLower.StartsWith("readonlystate") Then
                            ...
                            Dim getCurrentExpression = FormatConverters.ConvertToAbleToRead(FormatConverters.removeSpacesAtBeginningAndEnd(saveAtPoint.Substring(13)))
                            If File.Exists(FormatConverters.getExpression(getCurrentExpression)) Then
                                Dim FilePath = FormatConverters.getExpression(getCurrentExpression)
                                Dim attributes As FileAttributes = File.GetAttributes(FilePath)
                        ...
                        ElseIf saveAtPoint.ToLower.StartsWith("encryptedstate") Then
                            ...
                            Dim getCurrentExpression = FormatConverters.ConvertToAbleToRead(FormatConverters.removeSpacesAtBeginningAndEnd(saveAtPoint.Substring(14)))
                            If File.Exists(FormatConverters.getExpression(getCurrentExpression)) Then
                                Dim FilePath = FormatConverters.getExpression(getCurrentExpression)
                                Dim attributes As FileAttributes = File.GetAttributes(FilePath)
